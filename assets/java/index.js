...
let mainContentLetter =
    "Chúc bạn Lan Anh khum chỉ mỗi ngày sinh nhật vui vẻ, mà ngày nào cũng đều vui vẻ nhớ ^^ . Chúc bạn tuổi mới thật nhiều sức khỏe, khum bị ốm vặt nữa @@. Hi vọng những điều bạn dự định, đều sẽ đạt được. Mong rằng những điều tốt đẹp nhất thế giới sẽ đến với bạn ><. HAPPY BIRTHDAY BẠN IU ^^"; //Nội dung của bức thư
